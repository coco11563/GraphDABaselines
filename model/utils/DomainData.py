...
def construct_ds(name):
    path = "/home/xiaomeng/jupyter_base/home/xiaomeng/finatech/www/TACO_baselines/data/{}".format(name)
    print('loading data from {}'.format(path))
    return DomainData(path, name=name)

def construct_src(args):
    return construct_ds(args.source)

def construct_dst(args):
    return construct_ds(args.target)
